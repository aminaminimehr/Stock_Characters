"""CCM link loading and attachment (copied from production ccm.py)."""
...
from config import CCM_LINKPRIM, CCM_LINKTYPES
from wrds_io import raw_sql_with_retry
...
def attach_ccm_links_hxz(comp, link):
    ...
    linked = linked.sort_values(["gvkey", "datadate", "linkprim_priority", "permno", "linkdt"])
