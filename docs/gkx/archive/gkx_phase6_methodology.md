...
Reference priority: **Green SAS** > **GKX `accounting_100.py`** > GKX list.
...
| **GKX** | L405–410: equivalent structure |
...
| --- | --- |
| **Green SAS** | L192–193 |
| **GKX** | Not explicit in annual block |
...
| **GKX** | Not found in annual output |
...
| **GKX** | L112–117 (`dc` imputation); no `convind` export found |
