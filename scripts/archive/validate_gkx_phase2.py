#!/usr/bin/env python3
"""Lightweight validation for GKX Phase 2 annual characteristics."""
...
def main():
    parser = argparse.ArgumentParser(description="Validate GKX Phase 2 batch outputs.")
    ...
    text = "\n".join(lines) + "\n"
    docs_out = PROJECT_ROOT / "docs" / "gkx" / "gkx_phase2_validation.md"
    docs_out.parent.mkdir(parents=True, exist_ok=True)
    docs_out.write_text(text, encoding="utf-8")
    diag_out = DIAGNOSTICS_DIR / "gkx_phase2_validation.md"
